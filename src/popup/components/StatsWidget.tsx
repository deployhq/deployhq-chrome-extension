...
function DeltaIndicator({
  ...
  if (delta === 0) return <span className="text-xs text-gray-400 dark:text-gray-500">&mdash;</span>;
...
export default function StatsWidget({ stats, onClick }: StatsWidgetProps) {
  ...
  return (
    ...
    >
      {/* Deploys */}
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 px-3 py-2.5 flex items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-100 dark:bg-blue-900/40 shrink-0">
        ...
        <div>
          ...
          <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{stats.total_deployments}</p>
      ...
      {/* Success Rate */}
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 px-3 py-2.5 flex items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-100 dark:bg-emerald-900/40 shrink-0">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 px-3 py-2.5 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{stats.avg_duration}</p>
        </div>
      </div>

      {/* Active Servers */}
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 px-3 py-2.5 flex items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-purple-100 dark:bg-purple-900/40 shrink-0">
        ...
        <div>
          <p className="text-xs text-gray-500 dark:text-gray-400">Active Servers</p>
          <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{stats.active_servers}</p>
        </div>
      </div>
    </Container>
  );
